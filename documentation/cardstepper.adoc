= Schritt für Schritt zum Ziel: Konzept
...
TIP: Stellen Sie sich vor, Sie könnten vom Start bis zum Ende immer genau einen Schritt im Stundenablauf auf Ihrem Smartphone sehen? Und wenn Sie ihn absolviert haben, wischen Sie ihn einfach weg und gelangen zum nächsten Schritt!
...
Ein Webportal hat die Nöte von Fachkräften erkannt: www.getwanted.com. Das Startup _Wanted_, das seit Juli 2019 an einer Plattform arbeitet, wo Unternehmen sich mit einem Stellenangebot bei einer anonymen Fachkraft bewerben. Bedinungen: Angabe des Jahresgehalts.
